...
from . import actions_pivot as actions
...
########
# Could do something interesting here with node colour. 
# Add node_info.Human etc and change colour to vizualise 
#
#
########
...
class EnvironmentDebugging:
    ...
    def network_as_plotly_traces(self, xref: str = "x", yref: str = "y") -> Tuple[List[go.Scatter], dict]:
        ...
        def edge_text(source: model.NodeID, target: model.NodeID) -> str:
            ...
            print(f"Data for Source '{source}' to Target '{target}'-> '{data}'")
